...
class MyReorderableListTestPage extends StatefulWidget {
  MyReorderableListTestPage({Key key}) : super(key: key);

  @override
  _MyReorderableListTestPageState createState() => _MyReorderableListTestPageState();

  static void open(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) => MyReorderableListTestPage(),
    ));
  }
}
...
class _MyReorderableListTestPageState extends State<MyReorderableListTestPage> {
  List<ItemData> _items;
  _MyReorderableListTestPageState() {
    _items = List();
    for (int i = 0; i < 20; ++i) {
